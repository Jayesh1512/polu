...
const Page3 = () => {
  return (
    <div className="bg-cover bg-center h-[100vh] w-screen p-4" style={{ backgroundImage: `url(${backgroundImage})` }}>
      <div className="flex justify-center items-center">
      <div className="bg-white h-[80vh] w-full md:w-3/4 h-[80vh] lg:w-1/2 xl:w-2/3  flex flex-col md:flex-row p-4">
